...
#line 34 "grammar.y" /* yacc.c:1646  */
    { 
					Node n = (Node)getL(symbolList, (yyvsp[-2].node).name);
					if(n != 0)
					{
						free(n->value);
						n->type = (yyvsp[0].node).type;
						assignValue(n, (yyvsp[0].node).value);
					}
					else
					{
						addL(symbolList, newNode((yyvsp[-2].node).name, (yyvsp[0].node).type, (yyvsp[0].node).value));
					}
				}
...
#line 51 "grammar.y" /* yacc.c:1646  */
    {
					(yyval.node) = binaryOperation(&(yyvsp[-2].node), &(yyvsp[0].node), 0) 
				}
...
#line 55 "grammar.y" /* yacc.c:1646  */
    {
		  			(yyval.node) = binaryOperation(&(yyvsp[-2].node), &(yyvsp[0].node), 1); 
		  		}
...
#line 59 "grammar.y" /* yacc.c:1646  */
    {
		  			(yyval.node) = binaryOperation(&(yyvsp[-2].node), &(yyvsp[0].node), 2); 
		  		}
...
#line 63 "grammar.y" /* yacc.c:1646  */
    { 
		  			(yyval.node) = binaryOperation(&(yyvsp[-2].node), &(yyvsp[0].node), 3); 
		  		}
...
#line 67 "grammar.y" /* yacc.c:1646  */
    { 
		  			(yyval.node) = UMinusByType(&(yyvsp[0].node)); 
		  		}
...
#line 71 "grammar.y" /* yacc.c:1646  */
    { 
		  			...
		  			assignValue(&(yyval.node), (yyvsp[-1].node).value) ;
		  		}
...
#line 76 "grammar.y" /* yacc.c:1646  */
    { (yyval.node) = (Node) getL(symbolList, (yyval.node).name); }
